...
[Obsolete("LanManager should not be used. Replaced by a LANHelper...", true)]
public class OldLanManager : Singleton<OldLanManager> {
    ...
    public void ScanHost() {
        Debug.Log("OldLanManager::ScanHost(): Scanning host for local addresses ...");
        ...
        foreach (IPAddress ip in host.AddressList) {
            if (ip.AddressFamily == AddressFamily.InterNetwork) {
                ...
                Debug.Log("OldLanManager::ScanHost(): IP: " + address);
