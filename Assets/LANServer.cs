...
public class LANServer {
    ...
    public static void Start(int _maxPlayers, int _portNumber) {
        ...
        if (_socketServer == null) {
            try {
                ...
                _socketServer.BeginReceiveFrom(_receiveBuffer, 0, 1024, SocketFlags.None, ref _remoteEndPoint, new AsyncCallback(SocketOnReceiveCallBack), null);
            } catch (Exception ex) {
    ...
    private static void SocketOnReceiveCallBack(IAsyncResult _asyncResult) {
